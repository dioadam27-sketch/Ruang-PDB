...
export const ETicket: React.FC<ETicketProps> = ({ booking, onDownload, onNewBooking }) => {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (clonedDoc) => {
            ...
            if (clonedElement) {
                ...
                // Kita biarkan shadow agar "sama persis" dengan tampilan di layar
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-4 animate-fade-in-up bg-gray-100">
      ...
      <div 
        ...
        style={{ 
           ...
           backgroundSize: '20px 20px' // Pola kertas halus di luar, tapi container putih
        }}
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
            ...
            {/* Barcode Simulation (CSS Based for reliable export) */}
            <div className="w-full flex flex-col items-center justify-center pt-2">
                <div className="h-10 w-full max-w-[200px] mb-1" style={{ 
                    backgroundImage: `linear-gradient(90deg, 
                        ...
                        #000 67%, #000 71%, 
                        transparent 71%, transparent 73%, 
                        #000 73%, #000 77%, 
                        transparent 77%, transparent 79%, 
                        #000 79%, #000 85%, 
                        transparent 85%, transparent 87%, 
                        #000 87%, #000 92%, 
